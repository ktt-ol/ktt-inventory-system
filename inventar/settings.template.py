...
SERVER_EMAIL = 'your-mail@localhost'

ADMINS = (
	('Firstname Lastname', 'fl@localhost'),
)
...
LOCALE_PATHS = (
	'/path/to/ktt-inventory-system/inventar/conf/locale'
)
...
# Automatically create new users for new OpenID logins
